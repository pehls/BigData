...
public class CSVReaderDescription {
	...
	public CSVReaderDescription(String url) throws Exception {
		...
		try {
			...
			while ((customer = beanReader.read(Crime.class, header, processors)) != null) {
				...
				obj.put("id_crime", i);
				obj.put("description", customer.getDescription());ja.put(obj);
			...
			try {
				...
				FileWriter file = new FileWriter(
						"C:/Users/gabri/git/Projetos-Pessoais/BigData/src/com/bigdata/data/out/idXdescription.json");
