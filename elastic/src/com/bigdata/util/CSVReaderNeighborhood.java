...
public class CSVReaderNeighborhood {
	...
	public CSVReaderNeighborhood(String url) throws Exception {
		...
		try {
			...
			while ((customer = beanReader.read(Crime.class, header, processors)) != null) {
				...
				obj.put("id_crime", i);
				obj.put("neighborhood", customer.getNeighborhood());
				ja.put(obj);
			...
			try {
				...
				FileWriter file = new FileWriter(
						"C:/Users/gabri/git/Projetos-Pessoais/BigData/src/com/bigdata/data/out/idXneighborhood.json");
